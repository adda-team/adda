...
#define LENGTH(A) (sizeof(A)/sizeof(A[0]))    /* length of any array */
...
#define MAX_TMP_FNAME   15   /* maximum length of names of temporary files (short) */
...
#define BUF_LINE       100
#define MAX_PARAGRAPH  300   /* maximum length of a paragraph (few lines) */
/* derived sizes */
...
#define DEF_DPL    (10*sqrt(cAbs2(ref_index[0])))
