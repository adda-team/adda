...
/*  if((buf=scan_parms(buf,&beta_int))==NULL) LogError(EC_ERROR,ONE,POSIT,"Wrong format of file '%s'",fname); */
...
/*  if((buf=scan_parms(buf,&gamma_int))==NULL) LogError(EC_ERROR,ONE,POSIT,"Wrong format of file '%s'",fname); */
